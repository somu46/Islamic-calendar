...
const AboutUs = () => {
  return (
    <section className="bg-gradient-to-br from-blue-300 via-white to-gray-300 text-inherit py-12 mt-16 mb-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">About Us</h2>
          <p className="text-lg text-inherit mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-transparent text-inherit rounded-lg shadow shadow-white p-6 hover:scale-105 transform transition-all">
            <div className="flex justify-center mb-4">
              <FaHandsHelping className="text-inherit text-5xl" />
            </div>
          ...
          <div className="bg-transparent text-inherit rounded-lg shadow shadow-white p-6 hover:scale-105 transform transition-all">
            <div className="flex justify-center mb-4">
              <FaHeart className="text-inherit text-5xl" />
            </div>
          ...
          <div className="bg-transparent text-inherit rounded-lg shadow shadow-white p-6 hover:scale-105 transform transition-all">
            <div className="flex justify-center mb-4">
              <FaPeace className="text-inherit text-5xl" />
            </div>
